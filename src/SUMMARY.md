...
- [Android](android/README.md)
    ...
    - [App Components & Lifecycle](android/app_components.md)
    - [Dependency Injection](android/dependency_injection.md)
    - [Data & Persistence](android/data_persistence.md)
    ...
    - [Permissions & Privacy](android/permissions_privacy.md)
    ...
    - [Android Testing](android/testing_android.md)
        - [JUnit, MockK & Truth](android/testing_junit_mockk.md)
        - [Testing Coroutines & Flow](android/testing_coroutines.md)
        - [Robolectric](android/testing_robolectric.md)
        - [Espresso & UI Automator](android/testing_espresso.md)
        - [Compose UI Testing](android/testing_compose.md)
        - [Screenshot Testing](android/testing_screenshot.md)
...
- [Finance](finance/README.md)
    ...
    - [Factor Investing](finance/factor_investing.md)
