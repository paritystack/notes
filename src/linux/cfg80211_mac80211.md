...
cfg80211 and mac80211 are Linux kernel wireless subsystem frameworks. cfg80211 provides the configuration interface (nl80211 [netlink](netlink.md) family); mac80211 handles the 802.11 MAC layer for software-MAC drivers. [Driver development](driver_development.md) is the base skill needed to write a wireless driver. See [wifi/basics](../wifi/basics.md) for the 802.11 concepts these frameworks implement, and [networking](networking.md) for the Linux network stack above them.
...
- [Driver development](driver_development.md) — cfg80211/mac80211 drivers are a specialized class of kernel drivers
- [Netlink](netlink.md) — nl80211 is the netlink family for wireless configuration (used by `iw`, `wpa_supplicant`)
- [Networking](networking.md) — wireless interfaces are managed by the Linux network stack above mac80211
- [Wi-Fi basics](../wifi/basics.md) — the 802.11 concepts these frameworks implement
