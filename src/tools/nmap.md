...
- [tcpdump](tcpdump.md) — captures the traffic generated by nmap scans
- [Wireshark](wireshark.md) — analyzes nmap's packet exchanges for protocol understanding
- [curl](curl.md) — curl tests specific HTTP endpoints discovered by nmap
